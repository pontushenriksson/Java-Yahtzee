    ...
    public static void main(String[] args) throws InterruptedException, IOException {
        ...
        while (i == 1) {
            ...
            if (roll == 1) {
                ...
                System.out
                        .println("Do you want to re-roll" + " " + sorted2 + "?" + " " + "1 for yes and 0 for no.");
                dice2Roll = Input.nextInt();
                System.out
                        .println("Do you want to re-roll" + " " + sorted3 + "?" + " " + "1 for yes and 0 for no.");
                dice3Roll = Input.nextInt();
                System.out
                        .println("Do you want to re-roll" + " " + sorted4 + "?" + " " + "1 for yes and 0 for no.");
                dice4Roll = Input.nextInt();
                System.out
                        .println("Do you want to re-roll" + " " + sorted5 + "?" + " " + "1 for yes and 0 for no.");
